...
<body id="page-xxbd" class="page-color-card-form">
	<div class="container">
    <div style=" text-align:center; font-size:28px;"><p>停水公告</p></div><br />
		...
		<form id="fanuserform" class="color-card-form" data-parsley-trigger="focusout" novalidate="" runat="server">
					...
					<div class="form-row">
						<div class="input-row">
							<label>停水时间：</label> 
                                <asp:TextBox ID="start_time" runat="server" placeholder="请输入停水开始时间"  required="" data-parsley-id="6"></asp:TextBox><br /><br />
