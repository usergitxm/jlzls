<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index2.aspx.cs" Inherits="SCJN.Index2" %>
...
<body id="page-xxbd" class="page-color-card-form">	<br />
	    <div style=" text-align:center; font-size:23px;"><span>账单查询</span></div>
    <div class="container">
    <form id="fanuserform" class="color-card-form" action="Index2.aspx?action=up" data-parsley-trigger="focusout" novalidate="" runat="server">
        ...
        <div class="form-row">
					...
					<div class="form-row">
						<div class="input-row">
							<label>用户编号：</label> 
                            &ensp;<asp:DropDownList ID="UserID" CssClass="lblName" runat="server" name="DropDownList1" Width="125" Height="30"></asp:DropDownList>
						</div>
					</div><br />
                    <div class="form-row">
						<div class="input-row">
                    ...
                    <div class="form-row">
						<div class="input-row">
							<label>选择月份：</label> 
                             &ensp;<asp:DropDownList ID="DropDownList1" runat="server" name="DropDownList1" Width="125" Height="30">
                                <asp:ListItem Value="3">最近三个月</asp:ListItem>
                                <asp:ListItem Value="0">当月</asp:ListItem>
                                <asp:ListItem Value="6">最近半年</asp:ListItem>
		...
		<div class="handler-group">
			<div class="cell">
                        <asp:Button ID="Submit" runat=server Text="查询" onclick="Submit_Click" class="btn btn-lg btn-base col-xs-10 f-cb"/>
                        <br />
			</div>
		</div>
	</div>	
