        ...
        <div class="form-row">
                    ...
                    <br />
                     <div class="form-row">
						<div class="input-row">
							<label>选择月份：</label> 
                            &ensp; <asp:DropDownList ID="DropDownList1" runat="server" name="DropDownList1" 
                                Width="125px" Height="30">
                                   <asp:ListItem Value="22">全部</asp:ListItem>
                                   </asp:DropDownList>
						</div>
					</div> <br />
                    <div><p style="color: #FF0000; line-height:28px;">温馨提示：用户输入用户编号设置初始密码后可登录进行绑定信息、查询信息、缴纳水费，在输入编号时切记于自己编号后面加数字“1”。</p>
                    </div><br />
