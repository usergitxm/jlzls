...
<body class="cf_tsjy1body" mpa-version="7.16.11" mpa-extension-id="ibefaeehajgcpooopoegkifhgecigeeg">
    <form id="form1" runat="server" action="InstallationPay.aspx?action=up">
        ...
        <div class="cf_tsjy1cont02" id="imgList">
            <h3>备注信息<i style="color: #f40">*</i></h3>
            <div class="cf_tsjy1cont">
                <textarea id="content" placeholder="请输入备注信息" name="content" cols="100" rows="4" style="width: 100%; font-size: 15px; background-attachment: fixed; background-repeat: no-repeat; border: 1px solid #eee; text-indent: 10px; padding: 1rem 0;"></textarea>
            </div>
        </div>
