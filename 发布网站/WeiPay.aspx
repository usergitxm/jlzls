            ...
            <table id="Tab5" border="1px solid #999999" cellpadding="0" cellspacing="0" style="margin-top: 10px;">
                ...
                <tr>
                    <td colspan="2" style="border: 0px; text-align: center; padding-bottom: 5px;">
                        <input type="button" value="确认支付" id="getBrandWCPayRequest" style="height: 35px; height: 35px; color: #FFF; font-size: 16px; font-weight: bold; width: 94%; /*
	letter-spacing: 30px; */
	display: block; /*
	-moz-border-radius: 15px; -webkit-border-radius: 15px; */
	border-radius: 15px; background-image: url(img/5409.jpg); background-repeat: no-repeat; background-position: center center; /*margin-top: 15px; margin-right: auto; margin-bottom: 15px; */
	margin-left: 3%; margin-top: 10px; border: 1px solid #016599;"
                            onclick="SavePay()" />
                    </td>
                </tr>
            </table>
