<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BindId.aspx.cs" Inherits="SCJN.BindId" %>
...
<body id="page-xxbd" class="page-color-card-form">
    <br />
    <div style="text-align: center; font-size: 23px;"><span>用户绑定</span></div>
    <div class="container">
        <form id="fanuserform" class="color-card-form" data-parsley-trigger="focusout" novalidate="" runat="server">
            ...
            <div class="handler-group">
                <div class="cell">
                    <asp:Button ID="Submit" runat="server" Text="绑定信息" OnClick="Submit_Click" Width="287px" class="btn btn-lg btn-base col-xs-10 f-cb" /><br />
                    <asp:Button ID="Cancel" runat="server" Text="取消绑定" Width="287px" OnClick="Cancel_Click" class="btn btn-lg btn-base col-xs-10 f-cb" /><br />
                </div>
            </div>
    </div>
